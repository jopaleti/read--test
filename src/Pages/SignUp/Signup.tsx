...
function Signup() {
  ...
  return (
    <div className="animate__animated animate__zoomIn signup-container__ w-full bg-black flex flex-col justify-center items-center px-4">
      <Sign />
      {/* Signup form container */}
      <section className="mt-3 px-4 py-6 signup__section">
        <button className="shadow-2xl text-white">
          <div className="flex justify-center items-center gap-2 px-12 py-3">
            ...
            <h1 className="__h">Sign up with Google</h1>
          </div>
        </button>
        <div>
          <form action="#">
